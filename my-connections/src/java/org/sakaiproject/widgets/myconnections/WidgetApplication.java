...
public class WidgetApplication extends WebApplication {
	...
	public void init() {
		...
		getJavaScriptLibrarySettings().setJQueryReference(new UrlResourceReference(Url.parse("/my-connections/scripts/wicket/empty.js")));
		...
		getJavaScriptLibrarySettings().setWicketEventReference(new UrlResourceReference(Url.parse("/my-connections/scripts/wicket/wicket-event-jquery.min.js")));
